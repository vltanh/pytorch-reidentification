...
class TripletDataset(Dataset):
    ...
    def __getitem__(self, index):
        if self.train:
            ...
            img2, _ = self.train_data[positive_index]
            img3, _ = self.train_data[negative_index]
        else:
            img1, _ = self.test_data[self.test_triplets[index][0]]
            img2, _ = self.test_data[self.test_triplets[index][1]]
            img3, _ = self.test_data[self.test_triplets[index][2]]
